    ...
    <div className="w-full h-screen flex items-center justify-center bg-[#FFDBDB]">
        <div className="w-[400px] rounded-lg px-5 py-10 bg-white">
          ...
          <div className="mb-3 flex flex-col gap-2.5 text-left">
            ...
            <input className="rounded-lg border-gray-400 p-2.5" onChange={(e: React.ChangeEvent<HTMLInputElement>) => setEmail(e.target.value)} type="text" />
          </div>
          <div className="mb-3 flex flex-col gap-2.5 text-left">
            <label className="text-gray-700">password</label>
            <input className="rounded-lg border-gray-400 p-2.5" onChange={(e: React.ChangeEvent<HTMLInputElement>) => setPassword(e.target.value)} type="password" />
          </div>
